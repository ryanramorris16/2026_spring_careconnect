...
# File: quality/local/checks/check_checkstyle.sh
...
CHECKSTYLE_URL="https://github.com/checkstyle/checkstyle/releases/download/checkstyle-${CHECKSTYLE_VERSION}/checkst…
...
if ! command -v java > /dev/null 2>&1; then
  ...
  echo "java not installed - skipping Checkstyle."
...
if [ ! -d "${JAVA_SRC}" ]; then
  ...
  echo "src/main/java not found - skipping Checkstyle."
