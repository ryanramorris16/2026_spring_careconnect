 ...
 *
 *   TEXT  Ã¢â‚¬â€ analyzes transcript text with local heuristics
 *            Input: plain text string
 *
 *   VOICE Ã¢â‚¬â€ analyzes voice activity metrics from Chime
 *            Input: average level, speech ratio, variability
 *
 *   VIDEO Ã¢â‚¬â€ analyzes facial expressions and visual emotional cues
...
public class BedrockSentimentService {
  ...
  // Model IDs Ã¢â‚¬â€ configured in application-prod.properties
  ...
  public SentimentResult analyzeVideoFrame(String imageBase64, String imageFormat, String callId) {
    ...
    String prompt = """
      ...
      This is for clinical monitoring Ã¢â‚¬â€ be precise and objective.
  ...
  * Weights: voice 50%, video 50%
  ...
  // ================================================================
  // PRIVATE Ã¢â‚¬â€ AWS BEDROCK INVOCATION
  // ================================================================
  ...
  private String invokeNovaModel(String prompt, String imageBase64, String imageFormat) throws Exception {
    ...
    // Build content array Ã¢â‚¬â€ text only, or text + image
  ...
  /**
     * Low-level Bedrock invocation Ã¢â‚¬â€ same pattern as the POC we validated.
     */
  ...
  // ================================================================
  // PRIVATE Ã¢â‚¬â€ RESPONSE PARSING
  // ================================================================
