...
@Table(
        ...
        indexes = {
                @Index(
                        name = "idx_call_transcript_archive_call_id",
                        columnList = "call_id"
                ),
                @Index(
                        name = "idx_call_transcript_archive_archived_at",
                        columnList = "archived_at"
                )
        }
)
public class CallTranscriptArchive extends Auditable {
    ...
    @Column(
            ...
            nullable = false,
            length = STORAGE_PROVIDER_LENGTH
    )
