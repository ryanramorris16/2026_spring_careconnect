...
class InvoiceMapperTest {
    ...
    void privateConstructor_canBeInstantiatedViaReflection() throws Exception {
        Constructor<InvoiceMapper> ctor = InvoiceMapper.class.getDeclaredConstructor();
    ...
    void toEntity_nullProvider_providerFieldsRetainDefaults() throws Exception {
        ...
        Invoice e = InvoiceMapper.toEntity(dto);
    ...
    void toEntity_allSectionsPopulated_mapsAllFields() throws Exception {
        ...
        InvoiceDto.CheckPayableTo check = new InvoiceDto.CheckPayableTo();
        ...
        InvoiceDto.HistoryEntry he = new InvoiceDto.HistoryEntry();
        he.version = 1;
        he.changes = "initial";
        he.userId = "admin";
        he.action = "CREATE";
    ...
    void toDto_invoicePayment_allFields_mapped() throws Exception {
        ...
        PaymentDto d = InvoiceMapper.toDto(p);
    ...
    void toEntity_paymentDto_nullId_idIsUuidDefault() throws Exception {
        ...
        InvoicePayment p = InvoiceMapper.toEntity(invoice, d);
