...
class MockAIChatServiceTest {
    ...
    void processChat_nullUserId_returnsErrorResponse() {
        ...
        ChatResponse response = mockAIChatService.processChat(request);
    ...
    void processChat_noConversationId_createsNewConversation() {
        ...
        ChatConversation savedConversation = buildConversation("conv-123", 10L, 1L, "Hello there");
    ...
    void processChat_existingConversationId_usesExistingConversation() {
        ...
        ChatConversation existingConversation = buildConversation("existing-conv", 10L, 1L, "Original title");
    ...
    void processChat_conversationIdNotFound_createsNewConversation() {
        ...
        ChatConversation newConversation = buildConversation("new-conv", 10L, 1L, "Hello");
    ...
    void processChat_helloMessage_returnsMockGreeting() {
        ...
        ChatConversation conversation = buildConversation("c1", 10L, 1L, "hello");
    ...
    void processChat_hiMessage_returnsMockGreeting() {
        ...
        ChatConversation conversation = buildConversation("c2", 10L, 1L, "Hi there");
        when(chatConversationRepository.save(any(ChatConversation.class))).thenReturn(conversation);
        when(chatMessageRepository.save(any(ChatMessage.class))).thenAnswer(inv -> {
            ChatMessage msg = inv.getArgument(0);
            msg.setId(1L);
    ...
    void processChat_medicationMessage_returnsMedicationMockResponse() {
        ...
        ChatConversation conversation = buildConversation("c3", 10L, 1L, "Tell me about my medication");
        when(chatConversationRepository.save(any(ChatConversation.class))).thenReturn(conversation);
        when(chatMessageRepository.save(any(ChatMessage.class))).thenAnswer(inv -> {
            ChatMessage msg = inv.getArgument(0);
            msg.setId(1L);
    ...
    void processChat_medicineMessage_returnsMedicationMockResponse() {
        ...
        ChatConversation conversation = buildConversation("c4", 10L, 1L, "I need medicine info");
        when(chatConversationRepository.save(any(ChatConversation.class))).thenReturn(conversation);
        when(chatMessageRepository.save(any(ChatMessage.class))).thenAnswer(inv -> {
            ChatMessage msg = inv.getArgument(0);
            msg.setId(1L);
    ...
    void processChat_symptomMessage_returnsSymptomMockResponse() {
        ...
        ChatConversation conversation = buildConversation("c5", 10L, 1L, "I have a symptom");
        when(chatConversationRepository.save(any(ChatConversation.class))).thenReturn(conversation);
        when(chatMessageRepository.save(any(ChatMessage.class))).thenAnswer(inv -> {
            ChatMessage msg = inv.getArgument(0);
            msg.setId(1L);
    ...
    void processChat_painMessage_returnsSymptomMockResponse() {
        ...
        ChatConversation conversation = buildConversation("c6", 10L, 1L, "I have pain in my back");
        when(chatConversationRepository.save(any(ChatConversation.class))).thenReturn(conversation);
        when(chatMessageRepository.save(any(ChatMessage.class))).thenAnswer(inv -> {
            ChatMessage msg = inv.getArgument(0);
            msg.setId(1L);
    ...
    void processChat_genericMessage_returnsDefaultMockResponse() {
        ...
        ChatConversation conversation = buildConversation("c7", 10L, 1L, "What is the weather today?");
        when(chatConversationRepository.save(any(ChatConversation.class))).thenReturn(conversation);
        when(chatMessageRepository.save(any(ChatMessage.class))).thenAnswer(inv -> {
            ChatMessage msg = inv.getArgument(0);
            msg.setId(1L);
    ...
    void processChat_longMessageNoTitle_titleTruncatedTo47PlusEllipsis() {
        ...
        when(chatConversationRepository.save(any(ChatConversation.class))).thenAnswer(inv -> {
            ChatConversation saved = inv.getArgument(0);
    ...
    void getPatientConversations_patientWithConversations_returnsSummaries() {
        ...
        List<ChatConversationSummary> summaries = mockAIChatService.getPatientConversations(10L);
    ...
    void getPatientConversations_noConversations_returnsEmptyList() {
        ...
        List<ChatConversationSummary> summaries = mockAIChatService.getPatientConversations(99L);
    ...
    void getConversationMessages_validConversationId_returnsMessages() {
        ...
        List<ChatMessageSummary> messages = mockAIChatService.getConversationMessages("conv-msg");
    ...
    void getRecentMessagesForUser_userWithConversations_returnsRecentMessages() {
        ...
        List<ChatMessageSummary> messages = mockAIChatService.getRecentMessagesForUser(1L, 5);
    ...
    void getRecentMessagesForUser_noConversations_returnsEmptyList() {
        ...
        List<ChatMessageSummary> messages = mockAIChatService.getRecentMessagesForUser(99L, 10);
    ...
    void getRecentMessagesForUser_multipleConversations_usesFirstOne() {
        ...
        List<ChatMessageSummary> messages = mockAIChatService.getRecentMessagesForUser(1L, 3);
    ...
    void getPatientConversations_allFieldsMapped_summaryContainsAllFields() {
        ...
        assertThat(summaries).hasSize(1);
        ChatConversationSummary summary = summaries.get(0);
    ...
    void getConversationMessages_allFieldsMapped_messageSummaryContainsAllFields() {
        ...
        List<ChatMessageSummary> messages = mockAIChatService.getConversationMessages("conv-fields");

        assertThat(messages).hasSize(1);
        ChatMessageSummary summary = messages.get(0);
