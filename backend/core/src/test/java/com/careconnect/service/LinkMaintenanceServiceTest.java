...
class LinkMaintenanceServiceTest {
    ...
    void cleanupExpiredLinks_happyPath_delegatesToBothServices() {
    ...
    void cleanupExpiredLinks_caregiverServiceThrows_exceptionIsCaughtAndLogged() {
    ...
    void cleanupExpiredLinks_familyMemberServiceThrows_exceptionIsCaughtAndLogged() {
        doNothing().when(caregiverPatientLinkService).cleanupExpiredLinks();
    ...
    void notifyExpiringSoonLinks_happyPath_completesWithoutError() {
    ...
    void notifyExpiringSoonLinks_internalException_exceptionIsCaughtAndLogged() {
    ...
    void generateDailyLinkStatistics_happyPath_completesWithoutError() {
    ...
    void generateDailyLinkStatistics_internalException_exceptionIsCaughtAndLogged() {
