...
class UserControllerTest {
    ...
    void setupPassword_success_returnsOkWithMessage() throws Exception {
        ...
        ResponseEntity<?> response = controller.setupPassword(req);
    ...
    void searchUsers_currentUserNotFound_returnsBadRequest() throws Exception {
        ...
        ResponseEntity<List<UserResponse>> response = controller.searchUsers("alice", 99L);
    ...
    void searchUsers_excludesSelfAndReturnsList() throws Exception {
        ...
        ResponseEntity<List<UserResponse>> response = controller.searchUsers("alice", 1L);
    ...
    void searchUsers_noMatchesSelf_returnsAllResults() throws Exception {
        ...
        ResponseEntity<List<UserResponse>> response = controller.searchUsers("bob", 1L);
    ...
    void toggleLeaderboardOptIn_success_updatesAndReturnsOk() throws Exception {
        ...
        ResponseEntity<?> response = controller.toggleLeaderboardOptIn(1L, Map.of("optIn", true));
    ...
    void getLeaderboard_returnsOkWithEntries() throws Exception {
        ...
        ResponseEntity<List<LeaderboardEntry>> response = controller.getLeaderboard();
    ...
    void checkEmailExists_userFound_returnsExistsTrue() throws Exception {
        ...
        ResponseEntity<?> response = controller.checkEmailExists("found@test.com");
